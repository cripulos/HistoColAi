...
http://localhost:41062/HistoColAi/histocolai.html?source=images/**Batch_name**/dzi_images.json#

### 4 Specify File Type
After entering the batch name, you will be prompted to specify the file type:

**Enter WSI or DICOM depending on the type of image:**
...
### 6 Now you can view the images in the application using the URL:
http://localhost:41062/HistoColAi/histocolai.html?source=images/**Batch_name**/dzi_images.json#
